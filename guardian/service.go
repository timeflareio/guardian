...
func NewServiceWithClient(cfg *config.Config, client blockchain.ClientInterface, logger *zap.Logger) *Service {
	service := &Service{
		config:            cfg,
		logger:            logger,
		client:            client,
...
func (s *Service) verifyShareKeyBinding(guardian *blockchain.Guardian) error {
