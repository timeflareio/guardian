...
import (
	...
	"github.com/timeflareio/guardian/monitoring"
	"go.uber.org/zap"
)
...
func NewShareRevealService(cfg *config.Config, client blockchain.ClientInterface, logger *zap.Logger) *ShareRevealService {
...
func (srs *ShareRevealService) ProcessConfirmation(ctx context.Context,
	secret *blockchain.Secret, assignment *blockchain.GuardianAssignment,
...
func (srs *ShareRevealService) processConfirmation(ctx context.Context,
	secret *blockchain.Secret, assignment *blockchain.GuardianAssignment) error {
...
func (srs *ShareRevealService) ProcessReveal(ctx context.Context,
	secret *blockchain.Secret, assignment *blockchain.GuardianAssignment, currentHeight int64) error {
...
func (srs *ShareRevealService) validateShareIntegrity(
	secret *blockchain.Secret, assignment *blockchain.GuardianAssignment, share []byte) error {
...
func (srs *ShareRevealService) shouldRevealNow(secret *blockchain.Secret, currentHeight int64) bool {
...
// window-open exactly.
func (srs *ShareRevealService) plannedRevealHeight(secret *blockchain.Secret) int64 {
...
func (srs *ShareRevealService) decryptShare(ctx context.Context, secret *blockchain.Secret, encryptedShare []byte) ([]byte, error) {
