...
type CachedSecret struct {
	Secret      *chain.Secret             // Full secret data from blockchain
	Assignment  *chain.GuardianAssignment // Our specific assignment
...
func (cache *ActiveSecretCache) isActionableSecret(secret *chain.Secret, guardianAddr string, currentHeight int64) bool {
	// Find our assignment
...
func (cache *ActiveSecretCache) findAssignment(secret *chain.Secret, guardianAddr string) *chain.GuardianAssignment {
...
func (cache *ActiveSecretCache) determineLocalState(secret *chain.Secret, assignment *chain.GuardianAssignment, currentHeight int64) SecretLocalState {
...
func (cache *ActiveSecretCache) isInRevealWindow(secret *chain.Secret, currentHeight int64) bool {
...
func (cache *ActiveSecretCache) Initialize(ctx context.Context, client chain.ClientInterface, guardianAddr string, currentHeight int64) error {
...
func (cache *ActiveSecretCache) UpdateFromBlockchain(ctx context.Context, client chain.ClientInterface, guardianAddr string, currentHeight int64) error {
...
func (cache *ActiveSecretCache) addSecretUnsafe(secret *chain.Secret, guardianAddr string, currentHeight int64) {
	assignment := cache.findAssignment(secret, guardianAddr)
	if assignment == nil {
...
func (cache *ActiveSecretCache) updateSecretUnsafe(secret *chain.Secret, guardianAddr string, currentHeight int64) {
	cached := cache.secrets[secret.ID]
	if cached == nil {
