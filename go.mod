module github.com/timeflareio/guardian

go 1.26.5

// Carried pins — mirror the chain module's replace block exactly (both
// modules must pin the same sdk); see docs/guides/DEPENDENCIES.md.
replace (
	// Fix upstream GHSA-h395-qcrw-5vmq vulnerability.
	// Exit: when gin ≥ 1.9.1 arrives in the dependency graph naturally.
	github.com/gin-gonic/gin => github.com/gin-gonic/gin v1.9.1
	// Replace broken goleveldb release tag with the pre-release that builds.
	// Exit: first fixed upstream tag.
	github.com/syndtr/goleveldb => github.com/syndtr/goleveldb v1.0.1-0.20210819022825-2ae1ddf74ef7
	// Replace dead nhooyr.io vanity URL; upstream moved to coder/websocket.
	// Exit: when upstream dependents import coder/websocket directly.
...
require (
	...
	// Guardian-specific dependencies
...
require (
	...
	github.com/timeflareio/chain/x/secrets/types v0.0.4
